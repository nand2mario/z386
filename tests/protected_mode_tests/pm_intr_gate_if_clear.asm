; pm_intr_gate_if_clear.asm - Interrupt gate should clear IF on handler entry
...
isr_intr:
    ...
    test eax, 0x00000200
    jz .if_cleared
    mov dword [entry_if], 1
    jmp .after_if
.if_cleared:
    mov dword [entry_if], 0
.after_if:
...
idt:
    ...
    ; 32-bit interrupt gate (type=0xE)
    dw isr_intr
    dw SEL_CODE0
    db 0
    db 10001110b
